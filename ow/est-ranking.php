...
global $wpdb;
$i = 1;
$players = $wpdb->get_results("SELECT * FROM wp_ranking ORDER BY rank DESC;");
...
<div class="container">
    ...
    <div style="width: 100%; display:inline-block;">
        <h3 id="ranking-head" style="float:left; display:inline-block;">Eesti Ranking</h3>
        <!--
        ...
        <?php foreach ($players as $player): ?>
            <tr>
                ...
                <td style="padding-top:20px;"><a
                        href="../profiil/<?= $player['battletag'] ?>"><?= $player['nimi'] ?></a></td>
